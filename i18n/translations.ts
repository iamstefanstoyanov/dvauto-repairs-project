    ...
    sections: {
      ...
      contact: {
        ...
        appointment: {
          ...
          description: "Book your service slot in just a click and keep your car running smoothly.",
  ...
  bg: {
    ...
    sections: {
      ...
      contact: {
        ...
        emergency: {
          title: "Спешни обаждания 24/7",
          button: "Обади се сега",
        },
      },
    },
    footer: {
      ...
      services: [
        "Автосервизно обслужване",
        "Ремонт на спирачки",
        "Амортисьори и окачване",
        "Диагностика и ремонт",
        "Климатични услуги",
        "Гуми и баланс",
        "Ремонт на купе и боядисване",
        "Пътна помощ",
